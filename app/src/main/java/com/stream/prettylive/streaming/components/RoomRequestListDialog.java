...
import com.stream.prettylive.databinding.DialogRoomRequestListBinding;
...
public class RoomRequestListDialog extends BottomSheetDialog {
    ...
    private DialogRoomRequestListBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DialogRoomRequestListBinding
        binding = DialogRoomRequestListBinding.inflate(getLayoutInflater());
